...
type SutTypes = {
  sut: CreateAnimalController
  validatorSpy: ValidatorSpy
  saveAnimalSpy: SaveAnimalSpy
}

const mockRequest = (): CreateAnimalController.Request => ({
...
let request: CreateAnimalController.Request

const makeSut = (): SutTypes => {
  const validatorSpy = new ValidatorSpy()
  const saveAnimalSpy = new SaveAnimalSpy()
  const sut = new CreateAnimalController(validatorSpy, saveAnimalSpy)
  return {
    sut,
    validatorSpy,
    saveAnimalSpy
